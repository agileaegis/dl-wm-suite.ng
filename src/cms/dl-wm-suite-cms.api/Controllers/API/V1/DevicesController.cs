  ...
  public class DevicesController : BaseController
  {
    ...
    public async Task<IActionResult> PostDeviceRouteAsync([FromBody] DeviceForCreationUiModel deviceForCreationUiModel)
    {
      ...
      var newCreatedDepartment =
        await _createDeviceProcessor.CreateDeviceAsync(userAudit.Id, deviceForCreationUiModel);
    ...
    [ValidateModel]
    public async Task<IActionResult> PutDeviceRouteAsync(Guid id,
      [FromBody] DeviceForModificationUiModel deviceForModificationUiModel)
    {
