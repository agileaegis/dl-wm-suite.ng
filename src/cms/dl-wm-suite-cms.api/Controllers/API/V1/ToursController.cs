...
namespace dl.wm.suite.cms.api.Controllers.API.V1
{
    ...
    public class ToursController : BaseController
    {
        ...
        {
            return BadRequest(new {errorMessage = "UNKNOWN_ERROR_CREATION_NEW_TOUR"});
        }
        ...
        [ValidateModel]
        public async Task<IActionResult> PutTourRouteAsync(Guid  id, [FromBody] TourForModificationUiModel tourForModificationUiModel)
        {
