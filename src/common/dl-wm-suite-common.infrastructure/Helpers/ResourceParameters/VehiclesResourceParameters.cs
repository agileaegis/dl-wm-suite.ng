namespace dl.wm.suite.common.infrastructure.Helpers.ResourceParameters
{
    public class VehiclesResourceParameters : BaseResourceParameters
    {
        /// <summary>
        ...
        /// </summary> 
        public override string OrderBy { get; set; } = "VehicleNumPlate";
    }
}