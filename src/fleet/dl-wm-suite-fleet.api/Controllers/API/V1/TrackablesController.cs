...
namespace dl.wm.suite.fleet.api.Controllers.API.V1
{
    ...
    public class TrackablesController : BaseController
    {
        ...
        public async Task<IActionResult> GetTrackableAsync(int id, [FromQuery] string fields)
        {
            ...
            [FromHeader(Name = "Accept")] string mediaType)
        {
            ...
            if (mediaType.Contains("application/vnd.marvin.hateoas+json"))
            {
                ...
                var shapedPersons = trackables.ShapeData(trackablesResourceParameters.Fields);

                var shapedPersonsWithLinks = shapedPersons.Select(person =>
                {
                    var personAsDictionary = person as IDictionary<string, object>;
                    var personLinks =
                        CreateLinksForTrackable((int) personAsDictionary["Id"],
                            trackablesResourceParameters.Fields);
        ...
        private IEnumerable<LinkDto> CreateLinksForTrackable(int id, string fields)
        {
