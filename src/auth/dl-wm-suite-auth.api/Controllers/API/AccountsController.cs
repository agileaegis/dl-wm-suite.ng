...
using dl.wm.suite.auth.api.Controllers.API.Base;
...
namespace dl.wm.suite.auth.api.Controllers.API
{
    [ApiVersionNeutral]
    ...
    public class AccountsController : BaseController
    {
        ...
        public async Task<IActionResult> PutAccountActivateAsync(Guid userIdToBeActivated, [FromBody] AccountForActivationModification accountForActivation)
        {
            ...
            await _activateUserProcessor.UpdateUserActivatioAnync(userIdToBeActivated, userAudit.Id, accountForActivation);
